<x-app-layout>
    <div class="bg-gradient-to-br from-green-50 to-white min-h-screen py-10">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            <div class="mb-10">
                <h1 class="text-4xl font-extrabold text-green-900 mb-2">🎓 PSU-SCC Accreditation Portal</h1>
                <p class="text-lg text-gray-700">
                    Welcome, <span class="font-semibold text-green-700">Accreditor</span>! Your role is essential in reviewing and validating submitted documents for quality and compliance.
                </p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <!-- Accreditation Info -->
                <div class="lg:col-span-2 bg-white shadow-md rounded-2xl p-8 border border-green-100">
                    <h2 class="text-2xl font-semibold text-green-800 mb-4">🏛 About PSU-SCC Accreditation</h2>
                ...
                <!-- Role Overview -->
                <div class="bg-green-50 shadow-md rounded-2xl p-6 border border-green-100">
                    <h3 class="text-xl font-semibold text-green-700 mb-3">👤 Accreditor Responsibilities</h3>
                ...
                <!-- Guidelines -->
                <div class="lg:col-span-3 bg-white shadow-md rounded-2xl p-8 border border-green-100">
                    <h2 class="text-2xl font-semibold text-green-800 mb-4">📌 Document Review Guidelines</h2>
