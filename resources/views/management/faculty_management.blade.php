                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" 
                                ...
                                onclick="togglePasswordVisibility('addPassword', 'addPasswordEyeIcon', 'addPasswordEyeOffIcon')">
                                <svg id="addPasswordEyeIcon" class="h-5 w-5 text-gray-400 hover:text-gray-600 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                                <svg id="addPasswordEyeOffIcon" class="h-5 w-5 text-gray-400 hover:text-gray-600 cursor-pointer hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" 
                                class="absolute inset-y-0 right-0 pr-3 flex items-center"
                                onclick="togglePasswordVisibility('editPassword', 'editPasswordEyeIcon', 'editPasswordEyeOffIcon')">
